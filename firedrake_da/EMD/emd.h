...
#define EPSILON        1e-15 /*This accuracy will effect how long the algorithm costs, however it is important to make sure mean is this accurate after resample!! */
...
float emd(signature_t *Signature1, signature_t *Signature2,
	  ...
	  flow_t *Flow, int *FlowSize, float *F, int *ip, int *jp);
